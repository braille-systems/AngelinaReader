...
params.model_params.encoder_params.anchor_areas = [
    5 * 5.0,
]  # 6 * 6., 10 * 10.,
...
train_loader, (val_loader1, val_loader2) = DSBI_invest.data.create_dataloaders(
    params,
    collate_fn,
    data_dir=r"D:\Programming\Braille\Data\My",
    fn_suffix="",
    mode="inference",
    # mode = 'debug',
    verbose=2,
...
boxest, labelst, scores = encoder.decode(
    target[0][0].cpu().data, cls_preds, (w, h), cls_thresh=cls_thresh, nms_thresh=nms_thresh
)
print(len(boxest))
