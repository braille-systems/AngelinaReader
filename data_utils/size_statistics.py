...
def dir_statistics(data_dir, mask):
    ...
    print(
        ...
        "W: ",
        ww.quantiles((0, 0.05, 0.25, 0.5, 0.75, 0.95, 1)),
        "H: ",
        hh.quantiles((0, 0.05, 0.25, 0.5, 0.75, 0.95, 1)),
        "W2H:",
        w2hh.quantiles((0, 0.05, 0.25, 0.5, 0.75, 0.95, 1)),
    )
    #
    # print()
    # print(hh.print_hist())
