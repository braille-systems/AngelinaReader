...
label_is_valid = [
    True if (int_to_letter(int_label, ["SYM", "RU", "EN", "NUM"]) is not None) else False for int_label in range(64)
]
...
if __name__ == "__main__":
    ...
    print(
        [(label_is_valid[int_lbl], int_to_label123(int_lbl), int_to_letter(int_lbl, ["RU"])) for int_lbl in range(64)]
    )
